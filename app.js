...
var messenger_receive = function (event) {
  ...
  googleTranslate.translate(text, 'en', function(err, translation) {
    var test = response.respond(event.sender.id, translation.translatedText);
    googleTranslate.translate(test, translation.detectedSourceLanguage, function(err, translation) {
